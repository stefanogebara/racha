...
| **WhatsApp (Meta), pelo aparelho do DONO** (`wa.me`, desde 2026-09-26) | o telefone do cliente da carteira, o nome dele, o nome da casa e o valor devolvido, numa mensagem pronta | o dono avisar o cliente de que o saldo voltou (0044, compliance PR #44 M-3) — CDC art. 6º III | **não é operador da Racha**: o servidor só devolve o número inteiro ao dono naquela resposta (registrado no log, sem o número), e é o navegador do dono que abre o `wa.me`; o envio é do dono, controlador do dado do cliente da carteira, pela conta de WhatsApp dele (Meta, EUA). A página mostra o link e nada mais: nada é enviado sem o dono tocar |
