...
enum ClaimPatterns {
    ...
    static let distribuidorComSujeito = "(restaurante|restaurant|\\bcasa\\b|house|venue|estabelecimento)[^.;]{0,50}(distribu|reparte|repassa|liquida)|(distribu|reparte|repassa|liquida)[^.;]{0,60}(restaurante|restaurant|\\bcasa\\b|house|venue|estabelecimento|CNPJ)|CNPJ (do|da) (restaurante|casa|estabelecimento|pr[óo]prio)|(restaurante|restaurant|\\bcasa\\b|house|estabelecimento|CNPJ)[^.;]{0,40}(folha|payroll|n[óo]mina)|(folha|payroll|n[óo]mina)[^.;]{0,40}(restaurante|restaurant|\\bcasa\\b|house|estabelecimento|CNPJ)"
    static let revogaDispensa = "\\b(sem|n[ãa]o|nunca|nem|without|sin)\\b|\\bno\\s+(payroll|folha|n[óo]mina)|\\b(fora|por fora|antes|[àa] parte|em esp[ée]cie|direto)\\b"
