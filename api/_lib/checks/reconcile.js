...
const RECUSAS_DA_CARTEIRA = Object.freeze({
  ...
  // RH006 (0041): retry com a chave de um débito já estornado — outra tentativa.
  RH006: Object.freeze({ statusCode: 409, code: 'house_redeem_reversed' }),
  ...
  // valor). 500 e NÃO 409: o serviço trata à parte (tenta estornar e responde
  // `house_debit_mismatch`); o 500 só chega ao cliente se o estorno falhar.
