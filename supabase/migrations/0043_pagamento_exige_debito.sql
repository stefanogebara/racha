...
--
-- RH009 NÃO É 409 (o classificador em `reconcile.js` diz 500), de propósito: o
-- 409 faz o serviço ESTORNAR o débito, e aqui não há débito que bata pra
-- estornar. Cai no caminho de "falha desconhecida" (o débito, se existir,
-- fica; a conciliação aponta o par).
--
