...
export const DICT = {
  ...
  'pix.stopPaid':     { en: 'This table doesn’t owe anything anymore. Don’t pay this code. If you already paid it, you’re all set — your bank’s receipt is your proof.',
                        pt: 'Esta mesa não deve mais nada. Não pague este código. Se você já pagou, está tudo certo — o comprovante do seu banco é a sua prova.',
                        es: 'Esta mesa ya no debe nada. No pagues este código. Si ya lo pagaste, todo está bien — el justificante de tu banco es tu prueba.' },
  'pix.stopOver':     { en: 'The bill changed: the table now owes {left}, less than this code ({amount}). If you already paid this code, don’t make another — show your bank’s receipt at the till. If you haven’t, go back and make a code for the right amount.',
                        pt: 'A conta mudou: a mesa agora deve {left}, menos que este código ({amount}). Se você já pagou este código, não gere outro — mostre o comprovante do seu banco no caixa. Se ainda não pagou, volte e gere um código com o valor certo.',
                        es: 'La cuenta cambió: la mesa ahora debe {left}, menos que este código ({amount}). Si ya pagaste este código, no generes otro — enseña el justificante de tu banco en caja. Si aún no pagaste, vuelve y genera un código con el importe correcto.' },
  'pix.stopChanged':  { en: 'This table is on a new bill — this code was for the previous one. Don’t pay it. If you already paid it, show your bank’s receipt at the till.',
                        pt: 'Esta mesa já está numa conta nova — este código era da anterior. Não pague. Se você já pagou, mostre o comprovante do seu banco no caixa.',
                        es: 'Esta mesa ya está en una cuenta nueva — este código era de la anterior. No lo pagues. Si ya lo pagaste, enseña el justificante de tu banco en caja.' },
  'pix.chargeId':     { en: 'Charge ID: {id}', pt: 'Código da cobrança: {id}', es: 'Código del cobro: {id}' },
  'pix.stopBack':     { en: 'Back to the bill', pt: 'Voltar pra conta', es: 'Volver a la cuenta' },
  'pay.training':     { en: 'This is a training table: here the team practises the flow, and no payment is taken. To pay for real, ask at the till.',
                        pt: 'Esta é uma mesa de treino: aqui a equipe pratica o fluxo, e nenhum pagamento é feito. Pra pagar de verdade, fale no caixa.',
                        es: 'Esta es una mesa de prácticas: aquí el equipo practica el flujo, y no se cobra nada. Para pagar de verdad, pide en caja.' },
  'err.check_already_open': { en: 'This table already has an open bill.',
                        pt: 'Esta mesa já tem uma conta aberta.',
                        es: 'Esta mesa ya tiene una cuenta abierta.' },
  'err.check_changed': { en: 'The bill changed while we were saving it — check it and try again.',
                        pt: 'A conta mudou enquanto a gente gravava — confira e tente de novo.',
                        es: 'La cuenta cambió mientras la guardábamos — revísala e inténtalo de nuevo.' },
  'err.table_has_open_check': { en: 'This table has an open bill. Close it before marking the table as training.',
                        pt: 'Esta mesa tem uma conta aberta. Feche a conta antes de marcar a mesa como treino.',
                        es: 'Esta mesa tiene una cuenta abierta. Ciérrala antes de marcar la mesa como de prácticas.' },
  'err.table_training': { en: 'This is a training table — no payment is taken here. To pay for real, ask at the till.',
                        pt: 'Esta é uma mesa de treino — aqui nenhum pagamento é feito. Pra pagar de verdade, fale no caixa.',
                        es: 'Esta es una mesa de prácticas — aquí no se cobra nada. Para pagar de verdad, pide en caja.' },
  ...
  // A configuração do saldo no PAINEL DO DONO — era frase em português crua no
  // painel em inglês. O mínimo viaja em centavos e é formatado na moeda da casa.
  'err.house_config_invalid': { en: 'These settings could not be saved. Reload the page and try again.',
                        pt: 'Não deu pra salvar esta configuração. Recarregue a página e tente de novo.',
                        es: 'No se pudo guardar esta configuración. Recarga la página e inténtalo de nuevo.' },
  'err.house_bonus_out_of_range': { en: 'The bonus must be between 0% and 50%.',
                        pt: 'O bônus tem de ficar entre 0% e 50%.',
                        es: 'El bono debe estar entre el 0% y el 50%.' },
  'err.house_validity_out_of_range': { en: 'The bonus must last between 30 and 365 days (30 is the legal minimum).',
                        pt: 'A validade do bônus tem de ficar entre 30 e 365 dias (30 é o mínimo legal).',
                        es: 'La validez del bono debe estar entre 30 y 365 días (30 es el mínimo legal).' },
  'err.house_min_load_too_low': { en: 'The minimum top-up must be at least {min}.',
                        pt: 'A recarga mínima tem de ser de pelo menos {min}.',
                        es: 'La recarga mínima debe ser de al menos {min}.' },
  'err.house_max_load_invalid': { en: 'Enter a valid maximum top-up.',
                        pt: 'Informe uma recarga máxima válida.',
                        es: 'Introduce una recarga máxima válida.' },
  'err.house_min_above_max': { en: 'The minimum top-up cannot be higher than the maximum.',
                        pt: 'A recarga mínima não pode ser maior que a máxima.',
                        es: 'La recarga mínima no puede ser mayor que la máxima.' },
  ...
  'err.network_error':    { en: 'No connection right now. Check your internet and try again.',
                            pt: 'Sem conexão agora. Confira sua internet e tente de novo.',
                            es: 'Sin conexión ahora. Revisa tu internet e inténtalo de nuevo.' },
  ...
  'find.house_redeem_missing_payment_row': { en: 'a customer’s balance went down by {amount} and the payment never reached the bill — put it back with the button below and tell the customer today. Do not pay it back another way. Questions: contato@useracha.app',
                        pt: 'o saldo de um cliente baixou {amount} e o pagamento não entrou na conta — devolva ao saldo pelo botão abaixo e avise o cliente hoje. Não devolva por fora. Dúvidas: contato@useracha.app',
                        es: 'el saldo de un cliente disminuyó {amount} y el pago no llegó a la cuenta — devuélvelo al saldo con el botón de abajo y avisa al cliente hoy. No lo devuelvas de otra forma. Dudas: contato@useracha.app' },
  ...
  'gate.resetSent':   { en: 'If there is an account with this e-mail, we sent it a reset link.',
                        pt: 'Se houver conta com este e-mail, enviamos um link de redefinição pra ele.',
                        es: 'Si hay una cuenta con este correo, le hemos enviado un enlace de restablecimiento.' },
  'gate.moved':       { en: 'The owner login changed in September 2026 and old accounts were not transferred. Had an account before? Create it again with the same e-mail — then write to us so we link your restaurant back to it.',
                        pt: 'O login do painel mudou em setembro de 2026, e as contas antigas não foram transferidas. Já tinha conta? Crie de novo com o mesmo e-mail — e fale com a gente pra religar seu restaurante a ela.',
                        es: 'El acceso al panel cambió en septiembre de 2026 y las cuentas antiguas no se transfirieron. ¿Ya tenías cuenta? Créala de nuevo con el mismo correo — y escríbenos para volver a vincular tu restaurante.' },
  'err.session_expired': { en: 'Your session expired — sign in again.', pt: 'Sua sessão expirou — entre de novo.', es: 'Tu sesión caducó — entra de nuevo.' },
  ...
  // ── login ───────────────────────────────────────────────────────────────
  'gate.passwordRule': { en: 'At least {n} characters.',        pt: 'Pelo menos {n} caracteres.', es: 'Al menos {n} caracteres.' },
  'gate.resetTitle':  { en: 'Choose a new password',            pt: 'Escolha uma senha nova', es: 'Elige una contraseña nueva' },
  'gate.resetFor':    { en: 'Account: {email}. Not yours? Sign out below.', pt: 'Conta: {email}. Não é a sua? Saia abaixo.', es: 'Cuenta: {email}. ¿No es la tuya? Sal abajo.' },
  'gate.resetSave':   { en: 'Save password and sign in',        pt: 'Salvar senha e entrar', es: 'Guardar contraseña y entrar' },
  'err.auth_invalid_credentials': { en: 'Wrong e-mail or password. Check both, or use “Forgot password”.',
                        pt: 'E-mail ou senha errados. Confira os dois, ou use “Esqueci a senha”.',
                        es: 'Correo o contraseña incorrectos. Revisa ambos, o usa “He olvidado la contraseña”.' },
  'err.auth_email_not_confirmed': { en: 'Confirm your e-mail first — the link is in your inbox (check spam too).',
                        pt: 'Confirme seu e-mail primeiro — o link está na sua caixa de entrada (veja o spam também).',
                        es: 'Confirma tu correo primero — el enlace está en tu bandeja de entrada (mira también el spam).' },
  'err.auth_user_already_exists': { en: 'There is already an account with this e-mail. Sign in, or use “Forgot password”.',
                        pt: 'Já existe uma conta com este e-mail. Entre, ou use “Esqueci a senha”.',
                        es: 'Ya existe una cuenta con este correo. Entra, o usa “He olvidado la contraseña”.' },
  'err.auth_weak_password': { en: 'This password is too weak — use a longer one, mixing letters and numbers.',
                        pt: 'Esta senha é fraca demais — use uma mais longa, misturando letras e números.',
                        es: 'Esta contraseña es demasiado débil — usa una más larga, mezclando letras y números.' },
  'err.auth_same_password': { en: 'The new password must be different from the old one.',
                        pt: 'A senha nova tem que ser diferente da antiga.',
                        es: 'La contraseña nueva tiene que ser distinta de la anterior.' },
  'err.auth_email_address_invalid': { en: 'This e-mail address is not accepted — check it and try again.',
                        pt: 'Este endereço de e-mail não é aceito — confira e tente de novo.',
                        es: 'Esta dirección de correo no se acepta — revísala e inténtalo de nuevo.' },
  'err.auth_over_email_send_rate_limit': { en: 'Too many e-mails in a short time. Wait a few minutes and try again.',
                        pt: 'Muitos e-mails em pouco tempo. Espere alguns minutos e tente de novo.',
                        es: 'Demasiados correos en poco tiempo. Espera unos minutos e inténtalo de nuevo.' },
  'err.auth_over_request_rate_limit': { en: 'Too many attempts. Wait a few minutes and try again.',
  ...
  'admin.tablesHelp': { en: 'Register each table under the name it has on the floor (“Table 12”, “Bar 3”). Then mark one as {training} so the staff can practise: a training table never takes a payment.',
                        pt: 'Cadastre cada mesa com o nome que ela tem no salão (“Mesa 12”, “Balcão 3”). Depois marque uma como {training} pra equipe praticar: mesa de treino nunca cobra.',
                        es: 'Registra cada mesa con el nombre que tiene en la sala (“Mesa 12”, “Barra 3”). Luego marca una como {training} para que el equipo practique: una mesa de prácticas nunca cobra.' },
  ...
  'admin.confirmTraining': { en: 'Mark “{label}” as a training table? It stops taking payments until you take it off training.',
                        pt: 'Marcar “{label}” como mesa de treino? Ela para de cobrar até sair do treino.',
                        es: '¿Marcar “{label}” como mesa de prácticas? Deja de cobrar hasta que la quites de prácticas.' },
  ...
  'setup.s4ok':       { en: 'training table marked — it never takes a payment',
                        pt: 'mesa de treino marcada — ela nunca cobra',
                        es: 'mesa de prácticas marcada — nunca cobra' },
  ...
  'wiz.t3sub':        { en: 'Mark one table as training: the staff practise the flow on it, and it never takes a payment.',
                        pt: 'Marque uma mesa como treino: a equipe pratica o fluxo nela, e ela nunca cobra.',
                        es: 'Marca una mesa como prácticas: el equipo ensaya el flujo en ella, y nunca cobra.' },
  ...
  'wiz.script1':      { en: '1 · 15-minute pre-shift workshop: each waiter scans the training table on their OWN phone and goes through the bill up to the pay step — the table says it’s training and takes nothing. To see a payment go through, use the live demo on the website.',
                        pt: '1 · Workshop pré-turno de 15 min: cada garçom escaneia a mesa de treino NO PRÓPRIO CELULAR e percorre a conta até a hora de pagar — a mesa avisa que é treino e não cobra nada. Pra ver um pagamento ir até o fim, use a demo ao vivo do site.',
                        es: '1 · Taller de 15 minutos antes del turno: cada camarero escanea la mesa de prácticas EN SU PROPIO MÓVIL y recorre la cuenta hasta el momento de pagar — la mesa avisa que es de prácticas y no cobra nada. Para ver un pago completo, usa la demo en vivo de la web.' },
  ...
  'house.recreditAsk': { en: 'Put {amount} back into {name}’s balance? The payment never reached the bill. Do not also pay them back another way.',
                        pt: 'Devolver {amount} ao saldo de {name}? O pagamento não entrou na conta. Não devolva também por fora.',
                        es: '¿Devolver {amount} al saldo de {name}? El pago no llegó a la cuenta. No lo devuelvas también de otra forma.' },
  ...
  'land.dinerHint':  { en: 'At a table? Scan the QR code on it to open your bill.',
                      pt: 'Está numa mesa? Escaneie o QR dela para abrir sua conta.',
                      es: '¿Estás en una mesa? Escanea su código QR para abrir tu cuenta.' },
  'land.skipDemo':   { en: 'Skip the demo', pt: 'Pular a demo', es: 'Saltar la demo' },
