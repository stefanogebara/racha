...
export const DICT = {
  ...
  'priv.operator':   { en: 'Racha is run by {name}, CNPJ {cnpj}, {city}.',
                      pt: 'A Racha é operada por {name}, CNPJ {cnpj}, {city}.',
                      es: 'Racha está operada por {name}, CNPJ {cnpj}, {city}.' },
  ...
  'wallet.issuer':    { en: 'This balance is issued by {venue}: your top-up goes straight to the restaurant — Racha never holds the money.',
                        pt: 'Este saldo é emitido pelo {venue}: sua recarga vai direto pra conta do restaurante — a Racha não guarda o dinheiro.',
