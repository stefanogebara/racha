...
export const DICT = {
  ...
  'pix.stopOver':     { en: 'The bill changed: the table now owes {left}, less than this code ({amount}). If you already paid this code, don’t make another — show your bank’s receipt to the staff. If you haven’t, go back and make a code for the right amount.',
                        pt: 'A conta mudou: a mesa agora deve {left}, menos que este código ({amount}). Se você já pagou este código, não gere outro — mostre o comprovante do seu banco à equipe. Se ainda não pagou, volte e gere um código com o valor certo.',
                        es: 'La cuenta cambió: la mesa ahora debe {left}, menos que este código ({amount}). Si ya pagaste este código, no generes otro — enseña el justificante de tu banco al personal. Si aún no pagaste, vuelve y genera un código con el importe correcto.' },
  'pix.stopChanged':  { en: 'This table is on a new bill — this code was for the previous one. Don’t pay it. If you already paid it, show your bank’s receipt to the staff.',
                        pt: 'Esta mesa já está numa conta nova — este código era da anterior. Não pague. Se você já pagou, mostre o comprovante do seu banco à equipe.',
                        es: 'Esta mesa ya está en una cuenta nueva — este código era de la anterior. No lo pagues. Si ya lo pagaste, enseña el justificante de tu banco al personal.' },
