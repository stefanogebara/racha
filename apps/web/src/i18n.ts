...
export const DICT = {
  ...
  'pix.stopPaid':     { en: 'This table’s bill is already paid in full. Don’t pay this code — if it was you who paid, you’re all set.',
                        pt: 'A conta desta mesa já foi paga por completo. Não pague este código — se foi você quem pagou, está tudo certo.',
                        es: 'La cuenta de esta mesa ya está pagada por completo. No pagues este código — si el pago fue tuyo, todo está bien.' },
  'pix.stopOver':     { en: 'Someone paid part of the bill meanwhile: the table now owes {left}, and this code is for {amount}. Make a new code for the right amount.',
                        pt: 'Alguém pagou uma parte enquanto isso: a mesa agora deve {left}, e este código é de {amount}. Gere um código novo com o valor certo.',
                        es: 'Alguien pagó una parte mientras tanto: la mesa ahora debe {left}, y este código es de {amount}. Genera un código nuevo con el importe correcto.' },
  'pix.stopChanged':  { en: 'This table is on a new bill — this code was for the previous one. Don’t pay it. If you already paid it, show this screen to the staff.',
                        pt: 'Esta mesa já está numa conta nova — este código era da anterior. Não pague. Se você já pagou, mostre esta tela à equipe.',
                        es: 'Esta mesa ya está en una cuenta nueva — este código era de la anterior. No lo pagues. Si ya lo pagaste, enseña esta pantalla al personal.' },
