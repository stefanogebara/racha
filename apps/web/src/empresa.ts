 ...
 * inciso II pede ainda ENDEREÇO FÍSICO (falta: a cidade não basta — TASKS) e
 * CANAL ELETRÔNICO: `contato@useracha.app`, entrega conferida em 2026-09-26
 * (ver `docs/domains.md`, a linha com "entrega confirmada").
 *
